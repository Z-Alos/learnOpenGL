...
int main(){
    ...
    Shader blenderShader("../blender.vert", "../blender.frag");
    ...
    // --------WARNING-------
    // vertices alignment to cw & ccw matters
    ...
    unsigned int windowTexture = loadTexture("../../../res/textures/blending_transparent_window.png");

    blenderShader.use();
    blenderShader.setInt("texture1", 0);
