...
int main(){
    ...
    unsigned int diffuseMap = loadTexture("../../../res/textures/wooden_floor.png", true);
...
void processInput(GLFWwindow* window){
    ...
    // Blinn Phong/Phong
    if (glfwGetKey(window, GLFW_KEY_N) == GLFW_PRESS && !blinnKeyPressed){
        blinn = !blinn;
    ...
    // Gaama Correction 
    if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_PRESS && !gaamaKeyPressed){
        gaama= !gaama;
        gaamaKeyPressed = true;
    }
    if (glfwGetKey(window, GLFW_KEY_SPACE) == GLFW_RELEASE)
        gaamaKeyPressed = false;
}
